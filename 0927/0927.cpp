...
public:
    // 부모 클래스로부터 상속받은 멤버 함수를 재정의 -> 이름은 동일
    void print() {
        cout << "한국어" << endl;
    }
};
...
int main() {
    Language* lan;
    English en;     // English 클래스의 객체 생성
    Korean ko;      // Korean 클래스의 객체 생성

    en.print();     // 부모 클래스의 멤버 함수 호출
    ko.print();     // 멤버 함수를 호출하면 부모클래스의 멤버 함수가 아닌 재정의된 자식 클래스의 멤버함수가 호출됨 -> 오버라이딩 되어 부모클래스의 멤버함수는 숨겨지고 자식클래스에서 재정의 된 멤버함수가 우선순위로 호출이됨
...
int main() {
    ...
    en.print();     // 멤버 함수를 호출하면 부모클래스의 멤버 함수가 아닌 재정의된 자식 클래스의 멤버함수가 호출됨 -> 오버라이딩 되어 부모클래스의 멤버함수는 숨겨지고 자식클래스에서 재정의 된 멤버함수가 우선순위로 호출이됨
    ko.print();     // 멤버 함수를 호출하면 부모클래스의 멤버 함수가 아닌 재정의된 자식 클래스의 멤버함수가 호출됨 -> 오버라이딩 되어 부모클래스의 멤버함수는 숨겨지고 자식클래스에서 재정의 된 멤버함수가 우선순위로 호출이됨
}
*/
